...
embedding_dimension = 384  # Updated to match nomic-embed-text's dimension (previously 784)

index_name = "rhl-project-baii"
...
""" UI """
st.header("BAAI_BGE_SMALL EMBEDDER GROK Demo")
st.markdown("""
