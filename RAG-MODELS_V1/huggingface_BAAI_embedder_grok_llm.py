...
persist_directory = "./chroma_db"
collection_name = "rhl-project-baai-bge-small"  
...
""" UI """
st.header("LangChain BAAI(bge-small-en-v1.5) EMBEDDER GROK Demo")
st.markdown("""
